...
<main class="padding-20px background-light-grey">
    <div class="container">
        <div class="row">
            ...
            <div class="box-right">
                <?php foreach ($showVeMotChieu1 AS $k ){ ?>
...
<!--                                </div>-->
                                <div class="text-uppercase border-top-grey-1 pd-top-10 mr-15px">
                                    <strong class="text-medium text-third-color padding-right-5px font-weight-bold"><?php if($k['loaighe']==0){?>
                                        <?php echo  $k['giavethuong'];?>
                                    <?php }
                                    else{
                                        echo $k['giavethuonggia'];
                                    }
                                    ?>
                                    </strong>VNĐ
