    ...
    <div class="container">
     ...
     <h3 class="text-uppercase font-family-poppins col-6 d-inline-block fz-1rem pd-top-13px"><a href="#" class="text-dark"><span class="mr-right-30px">  Từ: <?=  showtensanbay(showiddiemdi(showidtuyenduong($k['idchuyenbay'])))?> </span>Đến:<?= showtensanbay(showiddiemden(showidtuyenduong($k['idchuyenbay'])))?> </a></h3> 
                ...
                <div class="text-uppercase border-top-grey-1 pd-top-10 mr-15px">
                    <strong class="text-medium text-third-color padding-right-5px mr-4 font-weight-bold"><span class="mr-1">Tiền:</span> <?=number_format($k['giavethuong'],0,",",".");?> <span class="mr-1">VNĐ</span></strong>
                    <strong class="text-medium text-third-color padding-right-5px font-weight-bold"><span class="mr-1">Giảm Giá:</span> <?=number_format($k['giamgia'],0,",",".");?><span class="mr-1"> VNĐ</span>
